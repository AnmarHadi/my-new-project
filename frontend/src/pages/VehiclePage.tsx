...
export default function VehiclesPage() {
  ...
  // ✅ التعديل هنا: التحقق من أن contractors موجودة وأيضاً أن لديها عناصر
  const getContractorName = (id?: string) => {
    if (!contractors || !Array.isArray(contractors) || contractors.length === 0) return "";
    ...
    >
      ...
      <Box sx={{ width: "100%", maxWidth: "100%", mb: 2, mx: "auto" }}>
        <Stack direction="row" gap={2} alignItems="center" justifyContent="center" sx={{ width: "100%" }}>
          <Button variant="contained" color="primary" sx={{ fontWeight: "bold", height: 56, flex: 1, minWidth: 110 }} fullWidth>
            بحث
          </Button>
      ...
      {!searched || vehicles.length === 0 ? (
        <Typography align="center" variant="body1" color="textSecondary" sx={{ my: 4 }}>
          {searched ? "لا توجد نتائج مطابقة" : "ابدأ البحث لإظهار النتائج"}
        </Typography>
      ) : null}
      ...
      <Dialog open={previewOpen} onClose={handleClosePreview} maxWidth="sm" fullWidth>
        ...
        <DialogActions sx={{ px: 3, pb: 2, display: "flex", justifyContent: "space-between", gap: 2 }}>
          <Button onClick={handleClosePreview} color="secondary" sx={{ minWidth: 120, fontWeight: 700 }} fullWidth>
            إغلاق
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="xs" fullWidth>
        ...
        <DialogActions sx={{ px: 3, pb: 2, display: "flex", justifyContent: "space-between", gap: 2 }}>
          <Button onClick={handleCloseDialog} color="secondary" sx={{ minWidth: 120, fontWeight: 700 }} fullWidth>
            إلغاء
          </Button>
          <Button
